...
import { decodeUserPermission } from '../lib/functions'
...
export default class Sidebar extends Component {
    ...
    state = {
        switchLabel: "Dark",
        defaultChecked: true,
        permission: decodeUserPermission(localStorage.getItem("userPermission"), localStorage.getItem("IdUser_PK"))
    }
    ...
    async componentDidMount() {
        ...
        this.switchInput()
        this.state.permission = decodeUserPermission(localStorage.getItem("userPermission"), localStorage.getItem("IdUser_PK"))
    ...
    collapseBtn = (e) => {
        ...
        Body.getAttribute("ariaExpanded") === "true"
            ? Body.ariaExpanded = "false"
            : Body.ariaExpanded = "true"
        Body.getAttribute("ariaLabel") === "collapse menu"
            ? Body.ariaLabel = "expand menu"
            : Body.ariaLabel = "collapse menu"
    }
    ...
    toggleMobileMenu = (e) => {
        ...
        Body.getAttribute("ariaExpanded") === "true"
            ? Body.ariaExpanded = "false"
            : Body.ariaExpanded = "true"
        Body.getAttribute("ariaLabel") === "open menu"
            ? Body.ariaLabel = "close menu"
            : Body.ariaLabel = "open menu"
    }
            ...
            <div className="page-header">
                ...
                <nav>
                    ...
                    <ul className="admin-menu">
                        ...
                        <li >{this.state.permission.superAdmin.access ?
                            <Link to="/test">
                                <i data-tip="Super Admin" className="fs-5 pe-2 bi bi-cpu"></i>
                                <span >superAdmin</span>
                            </Link> : ""}
                        </li>
                        <li >{this.state.permission.admin.access ?
                            <Link to="/">
                                <i data-tip="admin" className="fs-5 pe-2 bi bi-tools"></i>
                                <span >Admn</span>
                            </Link> : ""}
                        </li>
                        <li >{this.state.permission.client.access ?
                            <Link to="/">
                                <i data-tip="Requisiciones" className="fs-5 pe-2 bi bi-clipboard-plus"></i>
                                <span >Requisiciones</span>
                            </Link> : ""}
                        </li>
                        <li >{this.state.permission.companies.access ?
                            <Link to="/companies">
                                <i data-tip="Empresas" className="fs-5 pe-2 bi bi-building"></i>
                                <span >Empresas</span>
                            </Link> : ""}
                        </li>
                        <li >{this.state.permission.user.access ?
                            <Link to="/users">
                                <i data-tip="Usuarios" className="fs-5 pe-2 bi bi-person-plus"></i>
                                <span >Usuarios</span>
                            </Link> : ""}
                        </li>
                        <li >{this.state.permission.employes.access ?
                            <Link to="/">
                                <i data-tip="Empleados" className="fs-5 pe-2 bi bi-people"></i>
                                <span >Empleados</span>
                            </Link> : ""}
                        </li>
                        <li >{this.state.permission.manager.access ?
                            <Link to="/">
                                <i data-tip="Gerencia" className="fs-5 pe-2 bi bi-graph-up-arrow"></i>
                                <span >Gerencia</span>
                            </Link> : ""}
                        </li>
                        <li >{this.state.permission.commercial.access ?
                            <Link to="/">
                                <i data-tip="Comercial" className="fs-5 pe-2 bi bi-wallet"></i>
                                <span >Comercial</span>
                            </Link> : ""}
                        </li>
                        <li >{this.state.permission.leader.access ?
                            <Link to="/">
                                <i data-tip="Lider técnico" className="fs-5 pe-2 bi bi-diagram-3"></i>
                                <span >Lider técnico</span>
                            </Link> : ""}
                        </li>
                        <li >{this.state.permission.technical.access ?
                            <Link to="/">
                                <i data-tip="Ejecutor" className="fs-5 pe-2 bi bi-screwdriver"></i>
                                <span >Ejecutor</span>
                            </Link> : ""}
                        </li>
                        <li >{this.state.permission.humanTalent.access ?
                            <Link to="/">
                                <i data-tip="Talento Humano" className="fs-5 pe-2 bi bi-person-rolodex"></i>
                                <span >Talento Tumano</span>
                            </Link> : ""}
                        </li>
                        <li >{this.state.permission.logistic.access ?
                            <Link to="/">
                                <i data-tip="Logistica" className="fs-5 pe-2 bi bi-truck"></i>
                                <span >logistica</span>
                            </Link> : ""}
                        </li>
                        <li>
                            <div className="switch">
                                <input type="checkbox" checked={this.state.defaultChecked} id="mode" onChange={this.switchInput} />
                                <label htmlFor="mode">
                                    <span></span>
                                    <span>{this.state.switchLabel}</span>
                                </label>
                            </div>
                            <Link to="/profile">
                                <i data-tip="Configuración" className="fs-5 pe-2 bi bi-sliders"></i>
                                <span>Configuración</span>
                            </Link>
                            <Link to="/" onClick={this.CerrarSesion}>
                                <i data-tip="Cerrar Sesión" className="fs-5 pe-2 bi bi-door-closed-fill"></i>
                                <span>Cerrar Sesión</span>
                            </Link>
                            <button onClick={this.collapseBtn} className="collapse-btn" aria-expanded="true" aria-label="collapse menu">
